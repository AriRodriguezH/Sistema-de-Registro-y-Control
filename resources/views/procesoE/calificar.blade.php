...
<div class="d-flex justify-content-between align-items-center">
    <h1 class="font-weight-bold text-center mx-auto">Califica Proceso E</h1>
    <a href="{{ route('procesoE.index', ['return_url' => url()->current()]) }}" class="btn" style="background-color: #AAADAD; color: #FFFFFF; padding-left: 10px;" tabindex="6">
        <i class="fas fa-chevron-left" style="margin-right: 5px;"></i>
        Volver
    </a>
</div>
<br>
{{ Breadcrumbs::render('calificarProcesoE') }}
@stop
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if (count($archivos) > 1)
                            <a href="{{ route('procesoE.descargarArchivos', ['id' => $respuesta->id]) }}">Descargar archivos (ZIP)</a><br>
                            @else
                            <a href="{{ route('procesoE.descargarArchivos', ['id' => $respuesta->id, 'archivo' => $archivos[0]]) }}">Descargar archivo</a><br>
                            @endif
                    ...
                    <div class="modal fade" id="calificarRespuestaModal" tabindex="-1" role="dialog" aria-labelledby="calificarRespuestaModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                {!! Form::open(['route' => 'procesoE.calificarRespuesta', 'method' => 'POST']) !!}
                                {{ csrf_field() }}
                    ...
                    <div class="modal fade" id="editarCalificacionModal{{ $calificacion->id }}" tabindex="-1" role="dialog" aria-labelledby="editarCalificacionModal{{ $calificacion->id }}Label" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                {!! Form::open(['route' => ['procesoE.actualizarCalificacion', 'calificacionId' => $calificacion->id], 'method' => 'POST']) !!}
                                {!! Form::token() !!}
                                <div class="modal-body">
                                    <div class="form-group">
                                        {!! Form::label('porcentajeCumplimiento', 'Porcentaje de Cumplimiento:', ['class' => 'mr-2']) !!}
                                    ...
                                    <div class="form-group">
                                        {!! Form::label('comentario', 'Comentario:') !!}
                                        {!! Form::textarea('comentario', $calificacion->comentario, ['class' => 'form-control', 'required']) !!}
                                    </div>
                                </div>
                                <div class="modal-footer">
