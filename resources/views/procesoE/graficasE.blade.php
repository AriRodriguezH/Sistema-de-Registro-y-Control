...
<h4 class="font-weight-bold text-center">Grafica Proceso E</h4>
<br>
{{ Breadcrumbs::render('graficaDocumentacionCompletaE') }}
@stop
    ...
    Promise.all([
        ...
        .then(result => {
            if (result.success) {
                ...
                window.open('{{ url('/generar-pdfE/') }}' + '/' + result.nombreImagen1 + '/' + result.nombreImagen2, '_blank');
