...
<h1 class="font-weight-bold text-center">Editar Proceso E</h1>
{{ Breadcrumbs::render('editarPublicacionE') }}
@stop
...
<div class="card">
    <div class="card-body">
        ...
        {!! Form::model($publicacion, ['route' => ['procesoE.update', $publicacion->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
        @csrf
