...
<h1 class="font-weight-bold text-center">Editar Proceso G</h1>
{{ Breadcrumbs::render('editarPublicacionG') }}
...
<div class="card">
    <div class="card-body">
        ...
        {!! Form::model($publicacion, ['route' => ['procesoG.update', $publicacion->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
        @csrf
