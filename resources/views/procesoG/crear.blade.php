...
<h1 class="font-weight-bold text-center"> Proceso G</h1>
{{ Breadcrumbs::render('crearprocesoG') }}
...
<div class="card">
    ...
    <div class="card-body">
        {!! Form::open(array('route' => 'procesoG.store','method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
        @csrf
