...
<h4 class="font-weight-bold text-center">Grafica Proceso C</h4>
<br>
{{ Breadcrumbs::render('graficaDocumentacionCompletaC') }}
@stop
    ...
    Promise.all([
        ...
        .then(result => {
            if (result.success) {
                ...
                window.open('{{ url('/generar-pdfC/') }}' + '/' + result.nombreImagen1 + '/' + result.nombreImagen2, '_blank');
