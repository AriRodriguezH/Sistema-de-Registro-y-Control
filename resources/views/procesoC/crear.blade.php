...
<h1 class="font-weight-bold text-center"> Proceso C</h1>
{{ Breadcrumbs::render('crearprocesoC') }}
@stop
...
<div class="card">
    ...
    <div class="card-body">
        {!! Form::open(array('route' => 'procesoC.store','method'=>'POST','enctype' => 'multipart/form-data')) !!}
        @csrf
