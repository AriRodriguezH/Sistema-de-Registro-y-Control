...
<h1 class="font-weight-bold text-center">Editar Proceso F</h1>
{{ Breadcrumbs::render('editarPublicacionF') }}
...
<div class="card">
    <div class="card-body">
        ...
        {!! Form::model($publicacion, ['route' => ['procesoF.update', $publicacion->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
        @csrf
