...
<h1 class="font-weight-bold text-center"> Proceso F</h1>
{{ Breadcrumbs::render('crearprocesoF') }}
...
<div class="card">
    ...
    <div class="card-body">
        {!! Form::open(array('route' => 'procesoF.store','method'=>'POST','enctype' => 'multipart/form-data')) !!}
        @csrf
