...
<br>
{{ Breadcrumbs::render('calificarProcesoF') }}
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                            <a href="{{ route('procesoF.descargarArchivos', ['id' => $respuesta->id, 'archivo' => $archivos[0]]) }}">Descargar archivo</a><br>
                            @endif
                    ...
                    <div class="modal fade" id="calificarRespuestaModal" tabindex="-1" role="dialog" aria-labelledby="calificarRespuestaModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                {!! Form::open(['route' => 'procesoF.calificarRespuesta', 'method' => 'POST']) !!}
                                {{ csrf_field() }}
                    ...
                    <div class="modal fade" id="editarCalificacionModal{{ $calificacion->id }}" tabindex="-1" role="dialog" aria-labelledby="editarCalificacionModal{{ $calificacion->id }}Label" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                {!! Form::open(['route' => ['procesoF.actualizarCalificacion', 'calificacionId' => $calificacion->id], 'method' => 'POST']) !!}
                                {!! Form::token() !!}
                                <div class="modal-body">
                                    <div class="form-group">
                                        {!! Form::label('porcentajeCumplimiento', 'Porcentaje de Cumplimiento:', ['class' => 'mr-2']) !!}
...
<!--script para actualizar los valores de los campos ocultos cuando se hace clic en el enlace "Calificar respuesta":-->
<script>
    $(document).ready(function() {
