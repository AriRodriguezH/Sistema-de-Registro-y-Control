...
<h4 class="font-weight-bold text-center">Grafica Proceso F</h4>
<br>
{{ Breadcrumbs::render('graficaDocumentacionCompletaF') }}
@stop
    ...
    Promise.all([
        ...
        .then(result => {
            if (result.success) {
                ...
                window.open('{{ url('/generar-pdfF/') }}' + '/' + result.nombreImagen1 + '/' + result.nombreImagen2, '_blank');
