...
<h1 class="font-weight-bold text-center">Editar Proceso I</h1>
{{ Breadcrumbs::render('editarPublicacionI') }}
...
<div class="card">
    <div class="card-body">
        ...
        {!! Form::model($publicacion, ['route' => ['procesoI.update', $publicacion->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
        @csrf
