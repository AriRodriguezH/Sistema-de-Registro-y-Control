...
<div class="d-flex justify-content-between align-items-center">
    <h4 class="font-weight-bold text-center mx-auto">Responder publicación I</h4>
...
<br>
{{ Breadcrumbs::render('responderProcesoI') }}
...
<div class="card">
    <div class="card-body">
        ...
        <div class="modal fade" id="editarRespuestaModal" tabindex="-1" role="dialog" aria-labelledby="editarRespuestaModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content ">
                    ...
                    {!! Form::open(['route' => ['procesoI.actualizarRespuesta', $respuesta->id, $documentacion->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
        ...
        <h3>Responder:</h3>
        {!! Form::open(['route' => ['procesoI.guardarRespuesta', 'documentacionId' => $documentacion->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
        @csrf
        <div class="form-group">
