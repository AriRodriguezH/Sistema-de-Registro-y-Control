...
<h4 class="font-weight-bold text-center">Grafica Proceso I</h4>
<br>
{{ Breadcrumbs::render('graficaDocumentacionCompletaI') }}
@stop
    ...
    Promise.all([
        ...
        .then(result => {
            if (result.success) {
                ...
                window.open('{{ url('/generar-pdfI/') }}' + '/' + result.nombreImagen1 + '/' + result.nombreImagen2, '_blank');
