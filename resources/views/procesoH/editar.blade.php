...
<h1 class="font-weight-bold text-center">Editar Proceso H</h1>
{{ Breadcrumbs::render('editarPublicacionH') }}
...
<div class="card">
    <div class="card-body">
        ...
        {!! Form::model($publicacion, ['route' => ['procesoH.update', $publicacion->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
        @csrf
