...
<br>
{{ Breadcrumbs::render('crearprocesoA') }}
@stop
...
<div class="card">
    ...
    <div class="card-body">
        {!! Form::open(array('route' => 'procesoA.store', 'method' => 'POST', 'enctype' => 'multipart/form-data')) !!}
        @csrf
        ...
        <div class="mb-3">
            ...
            <div class="form-group">
                <label for="datepicker" style="font-size: 13px;">Año:</label>
            ...
            <a href="{{ route('procesoA.index', ['return_url' => url()->current()]) }}" class="btn btn-danger" tabindex="6" style="font-size: 13px;">Cancelar</a>
