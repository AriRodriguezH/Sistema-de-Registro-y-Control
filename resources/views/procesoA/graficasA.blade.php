...
<h4 class="font-weight-bold text-center">Grafica Proceso A</h4>
<br>
{{ Breadcrumbs::render('graficaDocumentacionCompletaA') }}
@stop
...
function capturarImagenYGenerarPDF() {
    Promise.all([
        ...
        // Capturar las imágenes en formato JPG
        ...
        .then(result => {
            if (result.success) {
                ...
                var pdfWindow = window.open('{{ url('/generar-pdfA/') }}' + '/' + result.nombreImagen1 + '/' + result.nombreImagen2, '_blank');
