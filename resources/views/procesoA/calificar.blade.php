...
<br>
{{ Breadcrumbs::render('calificarProcesoA') }}
@stop
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                            <a href="{{ route('procesoA.descargarArchivos', ['id' => $respuesta->id, 'archivo' => $archivos[0]]) }}">Descargar archivo</a><br>
                            @endif
                    ...
                    <div class="modal fade" id="calificarRespuestaModal" tabindex="-1" role="dialog" aria-labelledby="calificarRespuestaModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                {!! Form::open(['route' => 'procesoA.calificarRespuesta', 'method' => 'POST']) !!}
                                {{ csrf_field() }}
                                <div class="modal-body">
                                    <div class="form-group">
                                        {!! Form::label('porcentajeCumplimiento', 'Porcentaje de Cumplimiento:', ['class' => 'mr-2']) !!}
                                        <a data-toggle="tooltip" title="El porcentaje requerido para una documentación completa es de mínimo 80." class="ml-2">
                            ...
                            <div class="modal-content model-lg">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <p>Cumplimiento:
                                                @if ($calificacion->cumplimiento == 'Si')
                                                 <i class="fas fa-check text-success"> Si</i> <!-- Icono de paloma -->
                                                @else
                                        ...
                                        <div class="col-6">
                                            <a>Porcentaje de cumplimiento: {{ $calificacion->porcentajeCumplimiento }}</a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                    ...
                    <div class="modal fade" id="editarCalificacionModal{{ $calificacion->id }}" tabindex="-1" role="dialog" aria-labelledby="editarCalificacionModal{{ $calificacion->id }}Label" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                {!! Form::open(['route' => ['procesoA.actualizarCalificacion', 'calificacionId' => $calificacion->id], 'method' => 'POST']) !!}
                                {!! Form::token() !!}
                                <div class="modal-body">
                                    <div class="form-group">
                                        {!! Form::label('porcentajeCumplimiento', 'Porcentaje de Cumplimiento:', ['class' => 'mr-2']) !!}
