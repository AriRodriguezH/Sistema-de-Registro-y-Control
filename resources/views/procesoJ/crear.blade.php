...
<h1 class="font-weight-bold text-center"> Proceso J</h1>
{{ Breadcrumbs::render('crearprocesoJ') }}
...
<div class="card">
    ...
    <div class="card-body">
        {!! Form::open(array('route' => 'procesoJ.store','method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
        @csrf
        ...
        <div class="mb-3">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        {{ Form::label('descripcion_0', 'Descripción Documentación 1:',['style' => 'font-size: 13px;']) }}
