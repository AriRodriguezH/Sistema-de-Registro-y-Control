...
<h1 class="font-weight-bold text-center">Editar Proceso J</h1>
{{ Breadcrumbs::render('editarPublicacionJ') }}
...
<div class="card">
    <div class="card-body">
        ...
        {!! Form::model($publicacion, ['route' => ['procesoJ.update', $publicacion->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
        @csrf
