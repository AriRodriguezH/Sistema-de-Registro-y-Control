...
@section('content_header')
    <h4 class="font-weight-bold text-center">Grafica Proceso B</h4>
    {{ Breadcrumbs::render('graficaDocumentacionCompletaB') }}
    <br>
@stop
    ...
    Promise.all([
        ...
        .then(result => {
            if (result.success) {
                ...
                window.open('{{ url('/generar-pdfB/') }}' + '/' + result.nombreImagen1 + '/' + result.nombreImagen2, '_blank');
