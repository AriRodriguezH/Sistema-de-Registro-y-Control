...
<h1 class="font-weight-bold text-center">Editar Proceso B</h1>
{{ Breadcrumbs::render('editarPublicacionB') }}
@stop
...
<div class="card">
    <div class="card-body">
        ...
        {!! Form::model($publicacion, ['route' => ['procesoB.update', $publicacion->id], 'method' => 'PUT','enctype' => 'multipart/form-data']) !!}
        @csrf
