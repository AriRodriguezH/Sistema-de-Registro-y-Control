...
<h1 class="font-weight-bold text-center"> Proceso D</h1>
{{ Breadcrumbs::render('crearprocesoD') }}
@stop
...
<div class="card">
    ...
    <div class="card-body">
        {!! Form::open(array('route' => 'procesoD.store','method'=>'POST','enctype' => 'multipart/form-data')) !!}
        @csrf
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            {{ Form::file('archivos_1[]', ['class' => 'custom-file-input', 'multiple', 'style' => 'font-size: 13px;','accept' => '.pdf,.doc,.docx,.xls,.xlsx', 'id' => 'archivos_1','data-browse' => 'Seleccionar']) }}
