...
<div class="d-flex justify-content-between align-items-center">
    <h1 class="font-weight-bold text-center mx-auto">Responder Proceso D</h1>
...
<br>
{{ Breadcrumbs::render('responderprocesoD') }}
@stop
...
<div class="modal fade" id="editarRespuestaModal" tabindex="-1" role="dialog" aria-labelledby="editarRespuestaModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content ">
            ...
            {!! Form::open(['route' => ['procesoD.actualizarRespuesta', $respuesta->id, $documentacion->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
...
<h3>Responder:</h3>
{!! Form::open(['route' => ['procesoD.guardarRespuesta', 'documentacionId' => $documentacion->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
    @csrf
    <div class="form-group">
    {{ Form::label('archivos', 'Archivos:') }}
    <div class="custom-file">
        {{ Form::file('archivo[]', ['id' => 'archivos', 'class' => 'custom-file-input', 'multiple']) }}
        {{ Form::label('archivos', 'Seleccionar archivos', ['class' => 'custom-file-label']) }}
    </div>
</div>
<div class="form-group">
