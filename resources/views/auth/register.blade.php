            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="apellidoP" class="col-md-4 col-form-label text-md-end">{{ __('apellidoP') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="apellidoM" class="col-md-4 col-form-label text-md-end">{{ __('apellidoM') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="nombreUsuario" class="col-md-4 col-form-label text-md-end">{{ __('nombreUsuario') }}</label>
