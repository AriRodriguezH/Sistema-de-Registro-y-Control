...
class ProcesoC extends Controller
{
    ...
    {
        $proceso = DB::table('proceso')->select('identificador', 'nombreProceso')->where('id', 3)->first();
        ...
        return view('procesoC.index', compact('proceso', 'publicaciones','returnUrl'));
    }
    ...
    public function create()
    {
        ...
        return view('procesoC.crear', compact('tipoProcesoId'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $existePublicacion = Publicacion::where('proceso_id', 3)
        ...
        return redirect()->route('procesoC.index');
    }
    ...
    public function edit(string $id)
    {
        ...
        Breadcrumbs::for('editarPublicacionC', function ($trail) use ($publicacion) {
            $trail->parent('procesoC'); 
            $trail->push('Editar proceso', route('procesoC.edit', $publicacion->id)); 
        });

        return view('procesoC.editar', compact('publicacion', 'documentacion', 'tipoProcesoId')); //Se utiliza la función compact para pasar las variables publicacion, documentacion y tipoProcesoId a la vista
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('procesoC.index')->with('success_edit', 'La publicación y documentación se han actualizado correctamente.');
    }
    ...
    public function responder($id, $documentacionId)
    {
        ...
        Breadcrumbs::for('responderProcesoC', function ($trail) use ($id, $documentacionId) {
            $publicacion = Publicacion::findOrFail($id); 
            $documentacion = Documentacion::findOrFail($documentacionId); 
            ...
            $trail->parent('procesoC');
            $trail->push('Responder publicación', route('procesoC.responder', ['id' => $id, 'documentacionId' => $documentacionId])); 
        ...
        return view('procesoC.responder', compact('publicacion', 'documentacion', 'respuesta'));
    }
    ...
    public function calificar($id)
    {
        ...
        Breadcrumbs::for('calificarProcesoC', function ($trail) use ($publicacion) {
            $trail->parent('procesoC'); 
            $trail->push('Calificar publicación '. $publicacion->anioRegistro, route('procesoC.calificar', $publicacion->id)); 
        });

        return view('procesoC.calificar', compact('publicacion', 'documentaciones'));
    }
    ...
    public function graficaDocumentacionCompletaPorAnio()
    {
        ...
        $publicaciones = Publicacion::where('proceso_id', 3)->with('documentacion.calificaciones')->get();
        ...
        return view('procesoC.graficasC', compact('anioCompletas', 'anioIncompletas', 'porcentajeCompletas', 'datosGraficaBar'));
    }
    ...
    public function generaPDF($nombreImagen1, $nombreImagen2)
    {
        ...
        return $pdf->download('Reporte_Proceso_C.pdf');
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('procesoC.index')->with('success', 'La publicación y sus relaciones han sido eliminadas con éxito.');
        }  catch (\Exception $e) {
            // Manejo de errores
            return redirect()->route('procesoC.index')->with('error', 'Ha ocurrido un error al eliminar la publicación.');
        }
    }
}