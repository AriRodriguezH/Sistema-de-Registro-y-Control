...
class ProcesoF extends Controller
{
    ...
    {
        $proceso = DB::table('proceso')->select('identificador', 'nombreProceso')->where('id', 6)->first();
        ...
        return view('procesoF.index', compact('proceso', 'publicaciones','returnUrl'));
    }
    ...
    public function create()
    {
        ...
        return view('procesoF.crear', compact('tipoProcesoId'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $existePublicacion = Publicacion::where('proceso_id', 6)
        ...
        return redirect()->route('procesoF.index');
    }
    ...
    public function edit(string $id)
    {
        ...
        Breadcrumbs::for('editarPublicacionF', function ($trail) use ($publicacion) {
            $trail->parent('procesoF'); 
            $trail->push('Editar proceso', route('procesoF.edit', $publicacion->id)); 
        });

        return view('procesoF.editar', compact('publicacion', 'documentacion', 'tipoProcesoId')); //Se utiliza la función compact para pasar las variables publicacion, documentacion y tipoProcesoId a la vista
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('procesoF.index')->with('success_edit', 'La publicación y documentación se han actualizado correctamente.');
    ...
    public function responder($id, $documentacionId)
    {
        ...
        Breadcrumbs::for('responderProcesoF', function ($trail) use ($id, $documentacionId) {
            $publicacion = Publicacion::findOrFail($id); 
            $documentacion = Documentacion::findOrFail($documentacionId); 
            ...
            $trail->parent('procesoF');
            $trail->push('Responder publicación', route('procesoF.responder', ['id' => $id, 'documentacionId' => $documentacionId])); 
        ...
        return view('procesoF.responder', compact('publicacion', 'documentacion', 'respuesta'));
    }
    ...
    public function calificar($id)
    {
        ...
        Breadcrumbs::for('calificarProcesoF', function ($trail) use ($publicacion) {
            $trail->parent('procesoF'); 
            $trail->push('Calificar publicación '. $publicacion->anioRegistro, route('procesoF.calificar', $publicacion->id)); 
        });

        return view('procesoF.calificar', compact('publicacion', 'documentaciones'));
    }
    ...
    public function graficaDocumentacionCompletaPorAnio()
    {
        ...
        $publicaciones = Publicacion::where('proceso_id', 6)->with('documentacion.calificaciones')->get();
        ...
        return view('procesoF.graficasF', compact('anioCompletas', 'anioIncompletas', 'porcentajeCompletas', 'datosGraficaBar'));
    }
    ...
    public function generaPDF($nombreImagen1, $nombreImagen2)
    {
        ...
        return $pdf->download('Reporte_Proceso_F.pdf');
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('procesoF.index')->with('success', 'La publicación y sus relaciones han sido eliminadas con éxito.');
        }  catch (\Exception $e) {
            // Manejo de errores
            return redirect()->route('procesoF.index')->with('error', 'Ha ocurrido un error al eliminar la publicación.');
        }
    }
}