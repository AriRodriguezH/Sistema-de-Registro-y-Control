...
class ProcesoG extends Controller
{
    ...
    {
        $proceso = DB::table('proceso')->select('identificador', 'nombreProceso')->where('id', 7)->first();
        ...
        return view('procesoG.index', compact('proceso', 'publicaciones','returnUrl'));
    }
    ...
    public function create()
    {
        ...
        return view('procesoG.crear', compact('tipoProcesoId'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $existePublicacion = Publicacion::where('proceso_id', 7)
        ...
        return redirect()->route('procesoG.index');
    }
    ...
    public function edit(string $id)
    {
        ...
        Breadcrumbs::for('editarPublicacionG', function ($trail) use ($publicacion) {
            $trail->parent('procesoG'); 
            $trail->push('Editar proceso', route('procesoG.edit', $publicacion->id)); 
        });

        return view('procesoG.editar', compact('publicacion', 'documentacion', 'tipoProcesoId')); //Se utiliza la función compact para pasar las variables publicacion, documentacion y tipoProcesoId a la vista
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('procesoG.index')->with('success_edit', 'La publicación y documentación se han actualizado correctamente.');
    }
    ...
    public function responder($id, $documentacionId)
    {
        ...
        Breadcrumbs::for('responderProcesoG', function ($trail) use ($id, $documentacionId) {
            $publicacion = Publicacion::findOrFail($id); 
            $documentacion = Documentacion::findOrFail($documentacionId); 
            ...
            $trail->parent('procesoG');
            $trail->push('Responder publicación', route('procesoG.responder', ['id' => $id, 'documentacionId' => $documentacionId])); 
        ...
        return view('procesoG.responder', compact('publicacion', 'documentacion', 'respuesta'));
    }
    ...
    public function calificar($id)
    {
       $publicacion = Publicacion::findOrFail($id);
        ...
        Breadcrumbs::for('calificarProcesoG', function ($trail) use ($publicacion) {
            $trail->parent('procesoG'); 
            $trail->push('Calificar publicación '. $publicacion->anioRegistro, route('procesoG.calificar', $publicacion->id)); 
        });

        return view('procesoG.calificar', compact('publicacion', 'documentaciones'));
    }
    ...
    public function graficaDocumentacionCompletaPorAnio()
    {
        ...
        $publicaciones = Publicacion::where('proceso_id', 7)->with('documentacion.calificaciones')->get();
        ...
        return view('procesoG.graficasG', compact('anioCompletas', 'anioIncompletas', 'porcentajeCompletas', 'datosGraficaBar'));
    }
    ...
    public function generaPDF($nombreImagen1, $nombreImagen2)
    {
        ...
        return $pdf->download('Reporte_Proceso_G.pdf');
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('procesoG.index')->with('success', 'La publicación y sus relaciones han sido eliminadas con éxito.');
        }  catch (\Exception $e) {
            // Manejo de errores
            return redirect()->route('procesoG.index')->with('error', 'Ha ocurrido un error al eliminar la publicación.');
        }
    }
}