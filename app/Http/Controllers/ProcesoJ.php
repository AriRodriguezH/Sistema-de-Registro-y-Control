...
class ProcesoJ extends Controller
{
    ...
    {
        $proceso = DB::table('proceso')->select('identificador', 'nombreProceso')->where('id', 10)->first();
        ...
        return view('procesoJ.index', compact('proceso', 'publicaciones','returnUrl'));
    }
    ...
    public function create()
    {
        ...
        return view('procesoJ.crear', compact('tipoProcesoId'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $existePublicacion = Publicacion::where('proceso_id', 10)
        ...
        return redirect()->route('procesoJ.index');
    }
    ...
    public function edit(string $id)
    {
        ...
        Breadcrumbs::for('editarPublicacionJ', function ($trail) use ($publicacion) {
            $trail->parent('procesoJ'); 
            $trail->push('Editar proceso', route('procesoJ.edit', $publicacion->id)); 
        });

        return view('procesoJ.editar', compact('publicacion', 'documentacion', 'tipoProcesoId')); //Se utiliza la función compact para pasar las variables publicacion, documentacion y tipoProcesoId a la vista
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('procesoJ.index')->with('success_edit', 'La publicación y documentación se han actualizado correctamente.');
    ...
    public function responder($id, $documentacionId)
    {
        ...
        Breadcrumbs::for('responderProcesoJ', function ($trail) use ($id, $documentacionId) {
            $publicacion = Publicacion::findOrFail($id); 
            $documentacion = Documentacion::findOrFail($documentacionId); 
            ...
            $trail->parent('procesoJ');
            $trail->push('Responder publicación', route('procesoJ.responder', ['id' => $id, 'documentacionId' => $documentacionId])); 
        ...
        return view('procesoJ.responder', compact('publicacion', 'documentacion', 'respuesta'));
    }
    ...
    public function calificar($id)
    {
        ...
        Breadcrumbs::for('calificarProcesoJ', function ($trail) use ($publicacion) {
            $trail->parent('procesoJ'); 
            $trail->push('Calificar publicación '. $publicacion->anioRegistro, route('procesoJ.calificar', $publicacion->id)); 
        });

        return view('procesoJ.calificar', compact('publicacion', 'documentaciones'));
    }
    ...
    public function graficaDocumentacionCompletaPorAnio()
    {
        ...
        $publicaciones = Publicacion::where('proceso_id', 10)->with('documentacion.calificaciones')->get();
        ...
        return view('procesoJ.graficasJ', compact('anioCompletas', 'anioIncompletas', 'porcentajeCompletas', 'datosGraficaBar'));
    }
    ...
    public function generaPDF($nombreImagen1, $nombreImagen2)
    {
        ...
        return $pdf->download('Reporte_Proceso_J.pdf');
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('procesoJ.index')->with('success', 'La publicación y sus relaciones han sido eliminadas con éxito.');
        }  catch (\Exception $e) {
            // Manejo de errores
            return redirect()->route('procesoJ.index')->with('error', 'Ha ocurrido un error al eliminar la publicación.');
        }
    }
}