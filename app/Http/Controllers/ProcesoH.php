...
class ProcesoH extends Controller
{
    ...
    {
        $proceso = DB::table('proceso')->select('identificador', 'nombreProceso')->where('id', 8)->first();
        ...
        return view('procesoH.index', compact('proceso', 'publicaciones','returnUrl'));
    }
    ...
    public function create()
    {
        ...
        return view('procesoH.crear', compact('tipoProcesoId'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $existePublicacion = Publicacion::where('proceso_id', 8)
        ...
        return redirect()->route('procesoH.index');
    }
    ...
    public function edit(string $id)
    {
        ...
        Breadcrumbs::for('editarPublicacionH', function ($trail) use ($publicacion) {
            $trail->parent('procesoH'); 
            $trail->push('Editar proceso', route('procesoH.edit', $publicacion->id)); 
        });

        return view('procesoH.editar', compact('publicacion', 'documentacion', 'tipoProcesoId')); //Se utiliza la función compact para pasar las variables publicacion, documentacion y tipoProcesoId a la vista
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('procesoH.index')->with('success_edit', 'La publicación y documentación se han actualizado correctamente.');
    ...
    public function responder($id, $documentacionId)
    {
        ...
        Breadcrumbs::for('responderProcesoH', function ($trail) use ($id, $documentacionId) {
            $publicacion = Publicacion::findOrFail($id); 
            $documentacion = Documentacion::findOrFail($documentacionId); 
            ...
            $trail->parent('procesoH');
            $trail->push('Responder publicación', route('procesoH.responder', ['id' => $id, 'documentacionId' => $documentacionId])); 
        ...
        return view('procesoH.responder', compact('publicacion', 'documentacion', 'respuesta'));
    }
    ...
    public function calificar($id)
    {
        ...
        Breadcrumbs::for('calificarProcesoH', function ($trail) use ($publicacion) {
            $trail->parent('procesoH'); 
            $trail->push('Calificar publicación '. $publicacion->anioRegistro, route('procesoH.calificar', $publicacion->id)); 
        });

        return view('procesoH.calificar', compact('publicacion', 'documentaciones'));
    }
    ...
    public function graficaDocumentacionCompletaPorAnio()
    {
        ...
        $publicaciones = Publicacion::where('proceso_id', 8)->with('documentacion.calificaciones')->get();
        ...
        return view('procesoH.graficasH', compact('anioCompletas', 'anioIncompletas', 'porcentajeCompletas', 'datosGraficaBar'));
    }
    ...
    public function generaPDF($nombreImagen1, $nombreImagen2)
    {
        ...
        return $pdf->download('Reporte_Proceso_H.pdf');
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('procesoH.index')->with('success', 'La publicación y sus relaciones han sido eliminadas con éxito.');
        }  catch (\Exception $e) {
            // Manejo de errores
            return redirect()->route('procesoH.index')->with('error', 'Ha ocurrido un error al eliminar la publicación.');
        }
    }
}