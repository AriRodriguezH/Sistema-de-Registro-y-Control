...
class ProcesoI extends Controller
{
    ...
    {
        $proceso = DB::table('proceso')->select('identificador', 'nombreProceso')->where('id', 9)->first();
        ...
        return view('procesoI.index', compact('proceso', 'publicaciones','returnUrl'));
    }

    public function graficaDocumentacionCompletaPorAnio()
    {
        // Obtener todas las publicaciones con sus documentaciones asociadas
        $publicaciones = Publicacion::where('proceso_id', 9)->with('documentacion.calificaciones')->get();
        ...
        return view('procesoI.graficasI', compact('anioCompletas', 'anioIncompletas', 'porcentajeCompletas', 'datosGraficaBar'));
    }
    ...
    public function create()
    {
        ...
        return view('procesoI.crear', compact('tipoProcesoId'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $existePublicacion = Publicacion::where('proceso_id', 9)
        ...
        return redirect()->route('procesoI.index');
    }
    ...
    public function edit(string $id)
    {
        ...
        Breadcrumbs::for('editarPublicacionI', function ($trail) use ($publicacion) {
            $trail->parent('procesoI'); 
            $trail->push('Editar proceso', route('procesoI.edit', $publicacion->id)); 
        });

        return view('procesoI.editar', compact('publicacion', 'documentacion', 'tipoProcesoId')); //Se utiliza la función compact para pasar las variables publicacion, documentacion y tipoProcesoId a la vista
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('procesoI.index')->with('success_edit', 'La publicación y documentación se han actualizado correctamente.');
    ...
    public function responder($id, $documentacionId)
    {
        ...
        Breadcrumbs::for('responderProcesoI', function ($trail) use ($id, $documentacionId) {
            $publicacion = Publicacion::findOrFail($id); 
            $documentacion = Documentacion::findOrFail($documentacionId); 
            ...
            $trail->parent('procesoI');
            $trail->push('Responder publicación', route('procesoI.responder', ['id' => $id, 'documentacionId' => $documentacionId])); 
        ...
        return view('procesoI.responder', compact('publicacion', 'documentacion', 'respuesta'));
    }
    ...
    public function calificar($id)
    {
        ...
        Breadcrumbs::for('calificarProcesoI', function ($trail) use ($publicacion) {
            $trail->parent('procesoI'); 
            $trail->push('Calificar publicación '. $publicacion->anioRegistro, route('procesoI.calificar', $publicacion->id)); 
        });

        return view('procesoI.calificar', compact('publicacion', 'documentaciones'));
    }
    ...
    public function generaPDF($nombreImagen1, $nombreImagen2)
    {
        ...
        return $pdf->download('Reporte_Proceso_I.pdf');
    }
    ...
    public function destroy(string $id)
    {
        try {
            ...
            return redirect()->route('procesoI.index')->with('success', 'La publicación y sus relaciones han sido eliminadas con éxito.');
        }  catch (\Exception $e) {
            // Manejo de errores
            return redirect()->route('procesoI.index')->with('error', 'Ha ocurrido un error al eliminar la publicación.');
        }
    }
}